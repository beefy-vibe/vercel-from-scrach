        ...
        <Card className="w-full max-w-md">
          <CardContent className="p-6">
            <div className="text-center mb-6">
              <h1 className="text-2xl font-bold text-gray-900 mb-2">🎣 FishTracker</h1>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <Button
                  type="button"
                  variant="outline"
                  className="w-full flex items-center justify-center gap-3 h-11 bg-black text-white hover:bg-gray-800"
